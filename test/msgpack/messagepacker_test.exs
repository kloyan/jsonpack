defmodule MessagePackerTest do
    ...
    test "correctly packs integers" do
        ...
        assert MessagePacker.pack(18_446_744_073_709_551_615) == <<0xCF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF>>
    end
    ...
    test "correctly packs lists" do
        ...
        assert MessagePacker.pack(["t", "e", "s", "t"]) == <<148, 161, 116, 161, 101, 161, 115, 161, 116>>
    end
